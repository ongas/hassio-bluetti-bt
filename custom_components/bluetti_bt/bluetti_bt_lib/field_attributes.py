...
FIELD_ATTRIBUTES: dict[str, FieldAttributes] = {
    ...
    "ac_input_current": CurrentFieldAttributes("AC Input Current"),
    "ac_output_voltage": VoltageFieldAttributes("AC Output Voltage"),
    "dc_input_voltage": VoltageFieldAttributes("DC Input Voltage"),
    "dc_input_current": CurrentFieldAttributes("DC Input Current"),
    ...
    "ac_output_current_phase1": CurrentFieldAttributes("AC Output Current Phase 1"),
    "ac_output_current_phase2": CurrentFieldAttributes("AC Output Current Phase 2"),
    "ac_output_current_phase3": CurrentFieldAttributes("AC Output Current Phase 3"),
    "time_remaining": FieldAttributes(
        name="Time Remaining",
    ...
    "eco_on_ac": FieldAttributes(
        type=FieldType.BOOL,
        setter=True,
        name="Eco Mode AC",
    ),
    "eco_shutdown_ac": FieldAttributes(
        type=FieldType.ENUM,
        setter=True,
        name="Eco Shutdown AC",
        options=EcoShutdown,
    ),
